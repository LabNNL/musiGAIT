...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 84.0, 127.0, 760.0, 22.0 ],
					"text" : "t s s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 204.0, 96.0, 22.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 247.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 825.0, 168.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "path", "int" ],
					"patching_rect" : [ 36.0, 53.0, 980.0, 22.0 ],
					"text" : "t path 0"
				}
...
,
					"patching_rect" : [ 997.0, 204.0, 59.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "script delete __main__, script newdefault __main__ 84 300 bpatcher @name $1 @presentation 1 @presentation_rect 2. 1. 1188. 583."
				}
